...
This module implements the Main Menu and Navigation Flow.
It provides functions to send the main menu and register callback query handlers for the menu options.
...
def send_main_menu(bot, chat_id):
    ...
    Parameters:
        ...
        chat_id (int): The Telegram chat ID to send the menu to.
    """
...
def register_menu_handlers(bot):
    """
    Registers callback query handlers for the main menu options.
    This function should be called from the main bot initialization code.
    """
